...
func (startupScript *StartupScript) FillDefault(*prerequisites.Args) error {
	startupScript.ScriptPath = "/environment.sh"
	return nil
}

func (startupScript *StartupScript) FillDynamic(*prerequisites.Args) error {
	return nil
}

func (startupScript *StartupScript) CheckPrerequisites(*prerequisites.Args) error {
	return nil
}
