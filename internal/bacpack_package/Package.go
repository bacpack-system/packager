...
func (packg *Package) FillDefault(*prerequisites.Args) error {
	*packg = Package{
...
func (packg *Package) FillDynamic(args *prerequisites.Args) error {
	err := prerequisites.Initialize(&packg.PlatformString, args)
	return err
}

func (packg *Package) CheckPrerequisites(*prerequisites.Args) error {
