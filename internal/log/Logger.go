...
//
// The Logger should be created and initialized with prerequisites.CreateAndInitialize
// at the beginning of the program. Then anywhere in the codebase the log.GetLogger()
...
func GetLogger() *Logger {
	if loggerSingleton == nil {
		var err error
		loggerSingleton, err = prerequisites.CreateAndInitialize[Logger]()
		if err != nil {
...
func (logger *Logger) FillDefault(*prerequisites.Args) error {
...
func (logger *Logger) FillDynamic(args *prerequisites.Args) error {
...
func (logger *Logger) CheckPrerequisites(*prerequisites.Args) error {
...
func (logger *Logger) CreateContextLogger(imageName string, packageName string, logContext string) *ContextLogger {
	packageContextLogger, err := prerequisites.CreateAndInitialize[ContextLogger](
