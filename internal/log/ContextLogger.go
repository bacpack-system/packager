...
func (logger *ContextLogger) FillDefault(*prerequisites.Args) error {
	logger.logDirPath = ""
	logger.logFileName = ""
	return nil
}

func (logger *ContextLogger) FillDynamic(args *prerequisites.Args) error {
...
func (logger *ContextLogger) CheckPrerequisites(*prerequisites.Args) error {
